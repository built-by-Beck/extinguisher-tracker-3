...
All operational logic must run inside a single active organization
context.
...
The overall inspection result is chosen by the inspector and **not
automatically derived** from checklist values.
