        ...
        <div className="mx-auto max-w-4xl px-4 py-14 sm:px-6 sm:py-16">
          <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <p className="mt-3 text-sm text-gray-600">
              Answers about onboarding, pricing, AI support, and compliance
              workflow.
            </p>
          </div>
          ...
          <div className="mt-8 rounded-2xl bg-red-600 px-6 py-10 text-center">
            <h2 className="text-2xl font-bold text-white">
              Need the full onboarding flow?
            </h2>
            <p className="mx-auto mt-3 max-w-2xl text-sm text-red-100">
              Use our Getting Started page for the end-to-end setup path from
              signup to completed inspections.
            </p>
