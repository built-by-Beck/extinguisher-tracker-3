...
const REQUIRED_COLUMNS = [
  {
    name: 'assetId',
    description:
      'The unique ID or tag number for the extinguisher. Every row must have one — duplicates are skipped.',
    example: 'EX-001',
  },
  {
    name: 'serial',
    description:
      'The serial number printed on the extinguisher label or nameplate.',
    example: 'SN-12345',
  },
  {
    name: 'parentLocation',
    description:
      'The building, facility, or site the extinguisher is in. Think of this as the top-level location.',
    example: 'Building A',
  },
  {
    name: 'vicinity',
    description:
      'Where exactly is it? Describe the spot so someone can walk right to it.',
    example: 'By the exit door on 2nd floor',
  },
];
...
const OPTIONAL_COLUMNS = [
  {
    name: 'section',
    description:
      'Floor, wing, or zone — useful for large buildings with many extinguishers.',
    example: '2nd Floor',
  },
  {
    name: 'barcode',
    description: 'UPC or barcode value if you have one.',
    example: '012345678901',
  },
  {
    name: 'manufacturer',
    description: 'Brand name (Kidde, Amerex, Badger, etc.).',
    example: 'Kidde',
  },
  {
    name: 'extinguisherType',
    description: 'Type of agent — ABC Dry Chemical, CO2, Water, Foam, etc.',
    example: 'ABC Dry Chemical',
  },
  {
    name: 'serviceClass',
    description: 'Fire rating from the label.',
    example: '2-A:10-B:C',
  },
  {
    name: 'extinguisherSize',
    description: 'Weight or capacity.',
    example: '10 lbs',
  },
  {
    name: 'category',
    description:
      'Defaults to "standard" if blank. Options: standard, spare, replaced, retired, out_of_service.',
    example: 'standard',
  },
  {
    name: 'locationId',
    description: 'Room number or location ID if your facility uses them.',
    example: 'RM-101',
  },
  {
    name: 'manufactureYear',
    description: 'Four-digit year manufactured.',
    example: '2021',
  },
  {
    name: 'expirationYear',
    description: 'Four-digit year it expires.',
    example: '2033',
  },
];
    ...
    <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6">
      ...
      <div className="mb-8 rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
        <h2 className="text-lg font-bold text-gray-900">
          What you need for each extinguisher
        </h2>
        <p className="mt-2 text-sm text-gray-600">
          Each row in your spreadsheet is one extinguisher. You only need these
          4 things:
        </p>
        <div className="mt-4 grid gap-3 sm:grid-cols-2">
          ...
          <div className="rounded-lg border border-gray-100 bg-gray-50 p-4">
            ...
            <p className="mt-1 font-mono text-xs text-gray-400">
              e.g. Building A, Main Hospital
            </p>
          </div>
          <div className="rounded-lg border border-gray-100 bg-gray-50 p-4">
            <p className="font-semibold text-gray-900">vicinity</p>
            <p className="mt-1 text-sm text-gray-600">
              Exactly where it is — enough detail to find it
            </p>
            <p className="mt-1 font-mono text-xs text-gray-400">
              e.g. By the exit door on 2nd floor
            </p>
          </div>
        </div>
        <p className="mt-4 text-sm text-gray-500">
          That&apos;s it. Everything else is optional — you can fill in more
          details later from within the app.
        </p>
      </div>
      ...
      <div className="mb-8 rounded-xl border-2 border-dashed border-red-200 bg-red-50 p-6">
        ...
        <p className="mt-2 text-sm text-gray-600">
          Download our template, delete the example rows, and fill in your own
          data.
        </p>
        ...
        <p className="mt-3 text-xs text-gray-500">
          Most people should start with the basic template. The full template
          includes optional fields like manufacturer, type, size, and year.
        </p>
      </div>
      ...
      <div className="mb-8 rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
        ...
        <ul className="mt-3 space-y-2 text-sm text-gray-700">
          <li className="flex items-start gap-2">
            ...
            <span>
              <strong>CSV</strong> (.csv) — best compatibility
            </span>
          </li>
          <li className="flex items-start gap-2">
            <span className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-red-500" />
          ...
          <li className="flex items-start gap-2">
            <span className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-red-500" />
            <span>
              <strong>Text</strong> (.txt) — tab or pipe delimited
            </span>
          </li>
        </ul>
        <div className="mt-4 rounded-lg border border-amber-200 bg-amber-50 p-3">
          <p className="flex items-start gap-2 text-sm text-amber-800">
            ...
            <span>
              <strong>Google Sheets:</strong> File → Download → Comma Separated
              Values (.csv).
      ...
      <div className="mb-8 rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
        ...
        <ol className="mt-3 space-y-3 text-sm text-gray-700">
          ...
          <li className="flex items-start gap-3">
            ...
            <span>
              Select a <strong>default location</strong> from the dropdown, then
              click <strong>Browse</strong> or drag and drop your file.
            </span>
          </li>
          <li className="flex items-start gap-3">
            <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-red-100 text-xs font-bold text-red-700">
            ...
            <span>
              If your column names don&apos;t match exactly, a Column Mapper
              will appear — just match each column and click Import.
            </span>
          </li>
          <li className="flex items-start gap-3">
            <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-red-100 text-xs font-bold text-red-700">
            ...
            <span>
              Done! You&apos;ll see how many were imported and if any were
              skipped.
            </span>
          </li>
        </ol>
      ...
      <div className="mb-8 rounded-xl border border-blue-200 bg-blue-50 p-6">
        ...
        <p className="mt-2 text-sm text-gray-700">
          If your building has multiple floors or wings, add a{' '}
          <strong>section</strong> column to your spreadsheet (e.g. &quot;1st
          Floor&quot;, &quot;2nd Floor&quot;, &quot;West Wing&quot;). This is
          included in the full template.
        </p>
      </div>
      ...
      <details className="mb-8 rounded-xl border border-gray-200 bg-white shadow-sm">
        ...
        <div className="border-t border-gray-200 px-6 py-4">
          <p className="mb-4 text-sm text-gray-600">
            These columns are all optional. Your file doesn&apos;t need to match
            exactly — the system recognizes common names like &quot;Asset
            ID&quot;, &quot;Serial Number&quot;, &quot;Building&quot;,
            &quot;Location&quot;, etc.
          </p>
            ...
            <table className="w-full text-left text-sm">
              <thead>
                <tr className="border-b border-gray-200 bg-gray-50">
                  <th className="whitespace-nowrap px-3 py-2.5 font-semibold text-gray-900">
                    Column
                  </th>
                  <th className="px-3 py-2.5 font-semibold text-gray-900">
                    Description
                  </th>
                  <th className="whitespace-nowrap px-3 py-2.5 font-semibold text-gray-900">
                    Example
      ...
      <div className="mb-8 rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
        ...
        <ul className="mt-3 space-y-2 text-sm text-gray-600">
          <li>
            You can import up to <strong>499 extinguishers at a time</strong>.
            For larger lists, split the file and import in batches.
          </li>
          <li>
            If an asset ID already exists, that row is skipped — your existing
            data is never overwritten.
          </li>
          <li>
            Extra columns in your file are ignored, so you don&apos;t need to
            remove them.
          </li>
          <li>
            Don&apos;t have all the data? Import what you have now and use the{' '}
            <Link
